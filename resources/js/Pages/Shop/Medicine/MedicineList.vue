                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-dark" style="overflow-x: scroll">
                        ...
                        <tr>
                            ...
                            <th scope="col" style="width: 150px;vertical-align: middle">Name</th>
                            <th scope="col" style="width: 150px;vertical-align: middle">Stock</th>
                            <th scope="col" style="width: 150px;vertical-align: middle">Price</th>
                        ...
                        <tr v-for="permission in permissionOutput.data" :key="permission.id">
                            ...
                            <td style="vertical-align: middle">
                                <img height="50px" width="50px" v-if="permission.picture" :src="permission.picture" alt="">
                            ...
                            <td style="vertical-align: middle">{{permission.stock}}</td>
                            <td style="vertical-align: middle">{{permission.unit_price}}</td>
                            <td style="vertical-align: middle">
                                <inertia-link href="#" class="text-danger" data-toggle="tooltip" data-placement="top" title="Medicine delete" @click.prevent="suspendAdmin(permission.id)">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input v-model="medicineEdit.name" type="text" name="name" id="name" class="form-control" placeholder="Enter Name">
                        </div>
                        <div class="form-group">
                            <label for="brand">Brand</label>
                            <input v-model="medicineEdit.brand" type="text" name="brand" id="brand" class="form-control" placeholder="Enter brand">
                        </div>
                        <div class="form-group">
                            <label for="type">Type</label>
                            <select v-model="medicineEdit.type" name="type" id="type" class="form-control" aria-placeholder="Select type">
                        ...
                        <div class="form-group">
                            ...
                            <textarea v-model="medicineEdit.description" class="form-control" rows="4" name="description" id="description" placeholder="Description"></textarea>
                        </div>
                        <!--<div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input v-model="medicineEdit.weight" type="number" name="weight" id="weight" class="form-control" placeholder="Enter Weight">
                        </div>
                        <div class="form-group">
                            <label for="unitprice">Unit Price</label>
                            <input v-model="medicineEdit.unitPrice" type="number" name="unitprice" id="unitprice" class="form-control" placeholder="Enter unit price">
                        </div>
                        <div class="form-group">
                            <label for="stock">Stock</label>
                            <input v-model="medicineEdit.stock" type="number" name="stock" id="stock" class="form-control" placeholder="Enter stock">
                        </div>
                        <div class="form-group">
                            <label for="unitvalue">Unit value</label>
                            <input v-model="medicineEdit.unitValue" type="number" name="unitvalue" id="unitvalue" class="form-control" placeholder="Enter unit value">
                        </div>
                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            permissionPopUp(permission){
                this.medicineEdit.name = permission.name;
                this.medicineEdit.id = permission.id;
                this.medicineEdit.brand = permission.brand;
                this.medicineEdit.type = permission.type;
                this.medicineEdit.description = permission.description;
                this.medicineEdit.image = permission.image;
                this.medicineEdit.weight = permission.weight;
                this.medicineEdit.unitPrice = permission.unit_price;
                this.medicineEdit.stock = permission.stock;
                this.medicineEdit.unitValue = permission.unit_value;

            },
            permissionEditSubmit(){
                    this.$inertia.put('/admins/edit/medicine', this.medicineEdit).then(()=>{
            ...
            suspendAdmin(id){
                this.$confirm("Are you sure to delete this medicine?","Warning","warning").then(() => {
                    this.$inertia.delete('/admins/delete/medicine/'+id,{
                        replace: false,
                        preserveState: false,
                        preserveScroll: true,
                        only: [],
            ...
            dataTable(){
                this.isLoading = true;
                //this.$loading(true);
                axios.get('/admins/medicines/sort', {
                    params: {
