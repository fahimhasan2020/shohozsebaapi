                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-dark" style="overflow-x: scroll">
                        ...
                        <tr>
                            ...
                            <th scope="col" style="width: 150px;vertical-align: middle">Trade Licence</th>
                        ...
                        <tr v-for="permission in permissionOutput.data" :key="permission.id">
                            ...
                            <td style="vertical-align: middle">{{permission.trade_licence}}</td>
                            <td style="vertical-align: middle">
...
<script>
    export default {
        ...
        methods: {
            ...
            unSuspendAdmin(id){
                this.$confirm("Are you sure to suspend this nursing unit?","Warning","warning").then(() => {
                    this.$inertia.delete('/admins/nurse/suspend/'+id,{
                        replace: false,
                        preserveState: false,
                        preserveScroll: true,
            ...
            dataTable(){
                this.isLoading = true;
                //this.$loading(true);
                axios.get('/admins/nurse/datatable', {
                    params: {
